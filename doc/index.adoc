...
[source,clojure]
----
(th/get-tag {:tag :item :attribute {} :content ["Text"]})
;; => :item
----

[source,clojure]
----
(th/get-attributes {:tag :item :attribute {} :content ["Text"]})
;; => {}
----

[source,clojure]
----
(th/get-children {:tag :item :attribute {} :content ["Text"]})
;; => ["Text"]
----

[source,clojure]
----
(th/get-text {:tag :item :attribute {} :content ["Text"]})
;; => Text

(th/get-text {:tag :item {} :content [{:tag :item :attributes {} :content [...]}]})
;; => nil
----
